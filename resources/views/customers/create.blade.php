                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route("customers.store") }}">
                           ...
                           <div class="mb-3">
                               ...
                               <input class="form-control @error('comment') is-invalid @enderror" name="comment" type="text" value="{{ old('comment') }}">
                               <div class="invalid-feedback">@error('comment') {{ $message }} @enderror</div>
                           </div>
                           <div class="mb-3">
                               <label class="form-label">Company ID:</label>
                               <input class="form-control @error('company_id') is-invalid @enderror" name="company_id" type="text" value="{{ old('company_id') }}">
